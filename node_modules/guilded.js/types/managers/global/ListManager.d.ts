...
export declare class GlobalListItemManager extends GlobalManager {
     ...
     */
    create(channelId: string, options: RestBody<RestPath<"/channels/{channelId}/items">["post"]>): Promise<Schema<"ListItem">>;
    /**
     ...
     */
    update(channelId: string, itemId: string, options: RestBody<RestPath<"/channels/{channelId}/items/{listItemId}">["put"]>): Promise<Schema<"ListItem">>;
    /**
     * Deletes a list item.
     * @param channelId The ID of the channel that the list item belongs to.
