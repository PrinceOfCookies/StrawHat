...
class Router {
    ...
    updateCalendarEventRsvpMany(channelId, calendarEventId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.rest.put(routes_1.ROUTES.calendarEventRsvpsMany(channelId, calendarEventId), options);
        });
    }
    /**
    ...
    pinForumTopic(channelId, forumThreadId) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.rest.put(routes_1.ROUTES.forumTopicPin(channelId, forumThreadId));
        });
    }
    /**
    ...
    unpinForumTopic(channelId, forumThreadId) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.rest.delete(routes_1.ROUTES.forumTopicPin(channelId, forumThreadId));
        });
    }
    /**
    ...
    lockForumTopic(channelId, forumThreadId) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.rest.put(routes_1.ROUTES.forumTopicLock(channelId, forumThreadId));
        });
    }
    /**
    ...
    unlockForumTopic(channelId, forumThreadId) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.rest.delete(routes_1.ROUTES.forumTopicLock(channelId, forumThreadId));
        });
    }
    /**
     * Create a list item.
    ...
    getMe() {
        return __awaiter(this, void 0, void 0, function* () {
            return this.rest.get(routes_1.ROUTES.me());
        });
    }
    /**
    ...
    getWebhooks(serverId, channelId) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.rest.get(routes_1.ROUTES.serverWebhooks(serverId), channelId ? { query: { channelId } } : undefined);
        });
    }
    /**
     * Get a webhook
