...
export declare class GlobalForumTopicManager extends CacheableStructManager<number, ForumTopic> {
     ...
     */
    create(channelId: string, options: RestBody<RestPath<"/channels/{channelId}/topics">["post"]>): Promise<ForumTopic>;
    /**
     ...
     */
    fetchMany(channelId: string, options: RestQuery<RestPath<"/channels/{channelId}/topics">["get"]>): Promise<Collection<number, PartialForumTopic>>;
    /**
     ...
     */
    update(channelId: string, forumThreadId: string, options: RestBody<RestPath<"/channels/{channelId}/topics/{forumTopicId}">["patch"]>): Promise<ForumTopic>;
    /**
