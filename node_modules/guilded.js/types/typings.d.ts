import type { EmbedPayload, RestBody, RestPath, Schema } from "@guildedjs/guilded-api-typings";
...
export type UpgradedServerMemberPayload = IDUpgradePayload<ServerUpgradePayload<Schema<"ServerMember">>>;
export type UpgradedServerMemberBanPayload = ServerUpgradePayload<Schema<"ServerMemberBan">>;
export type UpgradedServerMemberSummaryPayload = IDUpgradePayload<ServerUpgradePayload<Schema<"ServerMemberSummary">>>;
...
export type MessageContent = (Omit<RestBody<RestPath<"/channels/{channelId}/messages">["post"]>, "embeds"> & {
...
export type ClientEvents = {
    ...
    listItemUpdated: (newItem: Schema<"ListItem">, oldItem: Schema<"ListItem"> | Schema<"ListItemSummary"> | null) => unknown;
    ...
    memberSocialLinkCreated: (serverId: string, socialLink: Schema<"SocialLink">) => unknown;
    memberSocialLinkUpdated: (serverId: string, socialLink: Schema<"SocialLink">) => unknown;
    memberSocialLinkDeleted: (serverId: string, socialLink: Schema<"SocialLink">) => unknown;
