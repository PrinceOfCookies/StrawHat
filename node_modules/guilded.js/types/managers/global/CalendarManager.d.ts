...
export declare class GlobalCalendarManager extends CacheableStructManager<number, CalendarEvent> {
     ...
     */
    create(channelId: string, options: RestBody<RestPath<"/channels/{channelId}/events">["post"]>): Promise<CalendarEvent>;
    /**
     ...
     */
    fetchMany(channelId: string, options: RestQuery<RestPath<"/channels/{channelId}/events">["get"]>): Promise<Collection<number, CalendarEvent>>;
    /**
     ...
     */
    update(channelId: string, calendarEventId: number, options: RestBody<RestPath<"/channels/{channelId}/events/{calendarEventId}">["patch"]>): Promise<CalendarEvent>;
    /**
     ...
     */
    updateRsvp(channelId: string, calendarEventId: number, userId: string, options: RestBody<RestPath<"/channels/{channelId}/events/{calendarEventId}/rsvps/{userId}">["put"]>): Promise<CalendarEventRsvp>;
    /**
     ...
     */
    updateManyRsvp(channelId: string, calendarEventId: number, options: RestBody<RestPath<"/channels/{channelId}/events/{calendarEventId}/rsvps">["put"]>): Promise<void>;
    /**
