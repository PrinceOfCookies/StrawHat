...
export declare class GlobalWebhookManager extends CacheableStructManager<string, Webhook> {
     ...
     */
    create(serverId: string, options: RestBody<RestPath<"/servers/{serverId}/webhooks">["post"]>): Promise<Webhook>;
    /**
     ...
     */
    update(serverId: string, webhookId: string, options: RestBody<RestPath<"/servers/{serverId}/webhooks/{webhookId}">["put"]>): Promise<Webhook>;
    /**
     * Delete a webhook
     * @param serverId The ID of the server the webhook is in
