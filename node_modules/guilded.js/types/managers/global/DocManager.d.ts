...
export declare class GlobalDocManager extends GlobalManager {
     ...
     */
    create(channelId: string, options: RestBody<RestPath<"/channels/{channelId}/docs">["post"]>): Promise<Schema<"Doc">>;
    /**
     ...
     */
    update(channelId: string, docId: number, options: RestBody<RestPath<"/channels/{channelId}/docs/{docId}">["put"]>): Promise<Schema<"Doc">>;
    /**
