...
class RestManager {
    ...
    make(data, authenticated = true, retryCount = 0, { returnAsText = false, bodyIsJSON = true, } = {}) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const queryAppendedURL = data.query
                ? `${data.path}?${(0, qs_1.stringify)(data.query)}`
                : data.path;
            ...
            if (!response.ok) {
                ...
                const rawResponse = yield response
                    .text()
                    .catch(() => "Could not read underlying response body buffer"); // this shouldn't happen
