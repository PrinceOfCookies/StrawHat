...
import type { ChannelType as APIChannelType, RestBody, RestPath, RestQuery, Schema } from "@guildedjs/guilded-api-typings";
...
export declare class Channel extends Base {
    ...
    constructor(client: Client, data: Schema<"ServerChannel"> & {
        deleted?: boolean;
    });
    /**
    ...
    _update(data: Partial<Schema<"ServerChannel"> & {
        deleted?: boolean;
    }>): this;
    /**
     ...
     */
    fetchMessages(options?: RestQuery<RestPath<"/channels/{channelId}/messages">["get"]>): Promise<Collection<string, Message>>;
    /**
     ...
     */
    update(options: RestBody<RestPath<"/channels/{channelId}">["patch"]>): Promise<Channel>;
    /**
     * Delete the channel.
     */
 ...
 */
export declare const channelTypeToEnumMap: Record<APIChannelType, ChannelType>;
