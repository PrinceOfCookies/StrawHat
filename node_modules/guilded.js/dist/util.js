...
exports.resolveContentToData = exports.buildCalendarRsvpKey = exports.buildReactionKey = exports.buildMessageReactionKey = exports.buildMemberKey = exports.ASSET_BUILDER = exports.IMG_EXTENSION = void 0;
...
const formAssetURL = (route, hash, extension, width, height, size) => {
    const url = new URL(`https://${rest_1.DOMAINS.IMAGE_CDN_DOMAIN}/${route}/${hash}-${size}.${extension.toLowerCase()}`);
    if (width)
