 ...
 */
export declare class CalendarEvent extends Base<Schema<"CalendarEvent">, number> {
 ...
 */
export declare class CalendarEventRsvp extends Base<Schema<"CalendarEventRsvp">, string> {
    /** The ID of the calendar event (min 1) */
