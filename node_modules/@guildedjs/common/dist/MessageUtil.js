...
exports.parseMessage = exports.parseToMessage = exports.generateMessage = void 0;
/* eslint-disable @typescript-eslint/no-non-null-assertion */
/* eslint-disable max-depth */
const embeds_1 = __importDefault(require("@guildedjs/embeds"));
const UUID_1 = require("./UUID");
/**
 * Convert a string or other content to a message suitable to be sent to guilded
 * @internal
 */
function generateMessage(input, embed) {
            ...
            nodes: [
                ...
                },
                {
                    data: {
                        ...
                        */
                        embeds: embed
                            ? embed instanceof embeds_1.default
                                ? [embed === null || embed === void 0 ? void 0 : embed.toJSON()]
                                : [embed]
                            : typeof input !== 'string'
                                ? input instanceof embeds_1.default
