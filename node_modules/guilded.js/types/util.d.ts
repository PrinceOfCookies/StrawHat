...
export declare const ASSET_BUILDER: {
     ...
     */
    SERVER_EMOJI: (hash: string, size?: string, extension?: "WEBP" | "APNG", width?: number, height?: number) => string;
    /**
     ...
     */
    SERVER_ICON: (hash: string, size?: "Small" | "Medium" | "Large") => string;
};
/**
 ...
 */
export declare const resolveContentToData: (content: MessageContent) => RestBody<RestPath<"/channels/{channelId}/messages">["post"]>;
