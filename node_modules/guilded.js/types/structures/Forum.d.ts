 ...
 */
export declare class ForumTopic extends Base<Schema<"ForumTopic">, number> {
    /**
    ...
    _update(data: Partial<Schema<"ForumTopic"> & {
        _deletedAt?: Date;
    }>): this;
}
/** A partial summary representation of a forum topic. Can fetch this topic to get full data */
export declare class PartialForumTopic extends Base<Schema<"ForumTopicSummary">, number> {
    /**
