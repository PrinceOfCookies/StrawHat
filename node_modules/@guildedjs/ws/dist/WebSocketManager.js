...
class WebSocketManager {
    ...
    get reconnectAttemptExceeded() {
        var _a;
        return (this.reconnectAttemptAmount >=
            ((_a = this.options.reconnectAttemptLimit) !== null && _a !== void 0 ? _a : Number.POSITIVE_INFINITY));
    }
    ...
    _handleDisconnect(opts) {
      ...
      Reconnect attempt limit ${this.options.reconnectAttemptLimit}.`);
        if ((!opts.blockReconnects && ((_a = this.options.autoConnectOnErr) !== null && _a !== void 0 ? _a : true)) ||
    ...
    onSocketMessage(packet) {
        ...
        switch (EVENT_DATA.op) {
            ...
            case guilded_api_typings_1.WSOpCodes.ERROR: {
