...
import { RestPath, RestQuery } from "@guildedjs/guilded-api-typings";
/**
...
export declare class GlobalMessageManager extends CacheableStructManager<string, Message> {
     ...
     */
    fetchMany(channelId: string, options: RestQuery<RestPath<"/channels/{channelId}/messages">["get"]>): Promise<Collection<string, Message>>;
    /**
