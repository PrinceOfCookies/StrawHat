...
import { Schema, ServerType as APIServerType } from "@guildedjs/guilded-api-typings";
/**
 * A class representing a Guilded server.
 */
export declare class Server extends Base<Schema<"Server">> {
...
export declare const ServerTypeMap: Record<APIServerType, ServerType>;
